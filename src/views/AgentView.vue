<template>
  <div class="agent-view">
    <div class="agent-shell">
      <section class="topology-pane surface-card">
...
import AnalysisConfigPanel from '../components/features/simulation/AnalysisConfigPanel.vue';
import SimpleTopologyMap from '../components/features/simulation/SimpleTopologyMap.vue';
...
const { loadData, lastSimConfig, componentParams, structureData, currentProject } = useSimulation();
...
const modelMetadata = computed(() => ({
  ...
  modelName: lastSimConfig.value?.simulation?.model_name || 'example_model.Cycle',
}));
