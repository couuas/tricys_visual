      ...
      <div class="dashboard-main">
        ...
        <div class="section-list">
          ...
          <div v-if="viewMode === 'personal'" class="project-list custom-scroll">
            <div v-for="project in recentProjects" :key="project.id || project.project_id" class="project-row" @click="selectProject(project)">
              <div class="row-icon">❖</div>
              <div class="p-info">
                <div v-if="editingProjectId === (project.id || project.project_id)" class="p-name-edit">
                  <input
                    v-model="editingName"
                    class="p-name-input"
                    type="text"
...
.section-create { flex: 1; min-width: 0; padding: 30px; border-right: 1px solid #30363d; background: linear-gradient(135deg, rgba(0,0,0,0.2), transparent); }
...
.p-name-input { width: 100%; background: #05070a; border: 1px solid #00d2ff; color: #fff; padding: 6px 8px; border-radius: 4px; font-size: 12px; }
