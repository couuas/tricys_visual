...
<style scoped>
.analysis-config-panel { position: relative; width: 100%; height: 100%; color: #c9d1d9; font-family: 'Inter', sans-serif; }
.panel-card { width: 700px; height: 85vh; max-width: 100%; background: #0d1117; border: 1px solid #30363d; border-radius: 12px; box-shadow: 0 30px 60px rgba(0, 0, 0, 0.8); display: flex; flex-direction: column; overflow: hidden; }
.embedded .panel-card { width: 100%; height: 100%; border-radius: 18px; border-color: rgba(255, 255, 255, 0.04); background: rgba(255, 255, 255, 0.015); box-shadow: none; }
.panel-header { padding: 15px 25px; background: #161b22; border-bottom: 1px solid #30363d; display: flex; justify-content: space-between; align-items: center; }
.embedded-panel-header { padding: 10px 14px; background: rgba(255, 255, 255, 0.018); border-bottom-color: rgba(255, 255, 255, 0.05); gap: 12px; }
.header-copy { min-width: 0; }
.title-gradient { margin: 0; font-size: 18px; font-weight: 700; background: linear-gradient(90deg, #00d2ff, #007bff); -webkit-background-clip: text; background-clip: text; color: transparent; }
.subtitle { margin: 0; font-size: 12px; color: #8b949e; }
.embedded-panel-header .title-gradient { font-size: 13px; font-weight: 600; background: none; color: #dce7ef; }
.embedded-panel-header .subtitle { margin-top: 2px; font-size: 11px; color: #8093a2; }
.close-btn { background: none; border: none; color: #8b949e; cursor: pointer; }
.close-btn:hover { color: #fff; }
.panel-body { flex: 1; display: flex; overflow: hidden; padding: 16px; min-height: 0; }
.step-container { width: 100%; height: 100%; min-height: 0; display: flex; flex-direction: column; overflow: hidden; }
.panel-full { width: 100%; display: flex; flex-direction: column; overflow-y: auto; }
.config-block { background: #161b22; border: 1px solid #30363d; border-radius: 6px; padding: 15px; margin-bottom: 20px; }
...
.input-styled, .input-mini-dark, .textarea-code { width: 100%; box-sizing: border-box; background: #0d1117; border: 1px solid #30363d; color: #c9d1d9; border-radius: 4px; padding: 8px; font-size: 12px; outline: none; transition: border 0.2s; }
.input-mini-dark { padding: 6px; font-size: 11px; background: #05070a; }
.textarea-code { background: #05070a; font-size: 11px; font-family: 'JetBrains Mono', monospace; }
.input-styled:focus, .input-mini-dark:focus, .textarea-code:focus { border-color: #00d2ff; }
.error-text { color: #f85149; font-size: 11px; margin-top: 5px; }
.info-text { font-size: 11px; color: #8b949e; font-style: italic; }
.grid-2col, .grid-2col-tight { display: grid; grid-template-columns: 1fr 1fr; gap: 8px; }
.grid-2col { gap: 16px; }
.flex-between { display: flex; justify-content: space-between; align-items: center; }
.flex-end { align-items: flex-end; }
.btn-micro-del, .link-btn, .help-btn, .close-help-btn, .close-btn, .back-btn, .btn-cancel, .btn-submit { cursor: pointer; }
.btn-micro-del { background: none; border: none; color: #484f58; padding: 2px; }
.btn-micro-del:hover { color: #f85149; }
.link-btn { background: none; border: none; color: #00d2ff; font-size: 11px; text-decoration: underline; }
...
.dropdown-list { position: absolute; top: 100%; left: 0; right: 0; z-index: 20; background: #161b22; border: 1px solid #30363d; max-height: 150px; overflow-y: auto; border-radius: 4px; box-shadow: 0 10px 20px rgba(0, 0, 0, 0.5); }
.dropdown-item { padding: 6px 10px; font-size: 11px; color: #c9d1d9; border-bottom: 1px solid #21262d; }
...
.panel-footer { padding: 15px 25px; background: #161b22; border-top: 1px solid #30363d; display: flex; justify-content: flex-end; gap: 10px; }
...
.checkbox-label { display: flex; align-items: center; gap: 8px; color: #c9d1d9; font-size: 11px; }
...
.step-indicator { display: inline-flex; align-items: center; gap: 8px; padding: 6px 10px; border-radius: 999px; border: 1px solid rgba(255, 255, 255, 0.07); background: rgba(255, 255, 255, 0.03); white-space: nowrap; }
.step-indicator-label { font-size: 10px; letter-spacing: 0.12em; text-transform: uppercase; color: #7c8d9a; }
.step-indicator-value { font-size: 11px; font-weight: 600; color: #d6e1e9; }
.back-btn { background: none; border: 1px solid #30363d; color: #ccc; padding: 4px 10px; border-radius: 4px; font-size: 11px; display: flex; align-items: center; gap: 5px; }
.template-grid { display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); align-items: stretch; align-content: start; gap: 14px; width: 100%; flex: 1; min-height: 0; overflow-y: auto; padding-right: 4px; }
.template-card { display: flex; align-items: center; gap: 14px; min-height: 120px; padding: 18px; border: 1px solid #30363d; border-radius: 12px; background: linear-gradient(180deg, rgba(22, 27, 34, 0.95) 0%, rgba(13, 17, 23, 0.98) 100%); transition: transform 0.18s ease, border-color 0.18s ease, box-shadow 0.18s ease; }
.embedded .panel-body { padding: 12px; }
.template-card:hover { transform: translateY(-2px); border-color: rgba(0, 210, 255, 0.45); box-shadow: 0 14px 28px rgba(0, 0, 0, 0.28); }
.card-icon { font-size: 28px; }
.card-content { flex: 1; }
.card-title { margin: 0 0 6px; font-size: 14px; }
.card-desc { margin: 0; font-size: 11px; color: #8b949e; line-height: 1.45; }
.card-arrow { color: #00d2ff; font-size: 18px; }
.help-btn { border: 1px solid #30363d; background: #0d1117; color: #8b949e; width: 18px; height: 18px; border-radius: 999px; font-size: 10px; line-height: 1; }
.help-overlay { position: absolute; inset: 0; background: rgba(0, 0, 0, 0.72); display: flex; align-items: center; justify-content: center; z-index: 40; }
.help-dialog { width: min(560px, calc(100% - 32px)); max-height: min(78vh, 720px); overflow: auto; background: #0d1117; border: 1px solid #30363d; border-radius: 14px; padding: 18px; }
.help-header { display: flex; justify-content: space-between; align-items: center; }
.close-help-btn { background: none; border: none; color: #8b949e; font-size: 20px; }
.help-intro { color: #8b949e; font-size: 12px; }
.help-list { padding-left: 18px; }
.hl-type { font-size: 12px; font-weight: 700; margin-bottom: 4px; }
.hl-desc { font-size: 11px; color: #8b949e; margin-bottom: 4px; }
.hl-code { font-size: 11px; margin-bottom: 10px; }
